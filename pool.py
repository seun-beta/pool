...
def design():
    top = Toplevel()
    top.title("Design for " + clicked_unit.get())

    global pump_performance

    if clicked_unit.get() == "Metric Unit":
        ...
        drainage_label = Label(top, text="Drainage No:")
        ...
        no_of_outlets_label = Label(top, text="Number of Return Wells:")
